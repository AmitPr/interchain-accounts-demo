...
$HERMES_BINARY --config ./network/hermes/config.toml keys delete --chain localkujira --all
...
$HERMES_BINARY --config ./network/hermes/config.toml keys add --chain localkujira --mnemonic-file ./network/hermes/mnemonic-test1.txt
sleep 5